...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, BookingResponse> bookingResponseConsumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<>(
                ...
                new JsonDeserializer<>(BookingResponse.class, false)
        );
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, BookingResponse> bookingResponseListenerFactory() {
